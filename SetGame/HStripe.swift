...
//
// Borrowed from: https://github.com/xtai/CS193p-SetGame/blob/main/SetGame/SetGameView/CardView/HStripe.swift
...
struct CardShadingView_Previews: PreviewProvider {
    static var previews: some View {
        HStripe(stripeSize: 3.0).previewLayout(.fixed(width: 100, height: 100))
    }
}
